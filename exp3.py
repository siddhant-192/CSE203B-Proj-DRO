...
print("--- CLEAN DATA ---")
print(f"ERM MSE:           {mean_squared_error(y_test, X_test @ beta_erm.value):.1f}")
print(f"Standard DRO MSE:  {mean_squared_error(y_test, X_test @ beta_std_dro.value):.1f}")
print(f"Weighted DRO MSE:  {mean_squared_error(y_test, X_test @ beta_w_dro.value):.1f}")

print("\n--- CORRUPTED DATA ---")
print(f"ERM MSE:           {mean_squared_error(y_test, X_test_corrupted @ beta_erm.value):.1f}")
print(f"Standard DRO MSE:  {mean_squared_error(y_test, X_test_corrupted @ beta_std_dro.value):.1f}")
print(f"Weighted DRO MSE:  {mean_squared_error(y_test, X_test_corrupted @ beta_w_dro.value):.1f}\n")
